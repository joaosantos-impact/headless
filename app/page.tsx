        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              {
                icon: FileText,
                title: "Organização de Faturas e Documentos",
                desc: "O agente recebe faturas por email ou upload, extrai dados automaticamente, categoriza por fornecedor e exporta para o teu sistema de contabilidade.",
                tag: "Financeiro",
                metric: "2.000+ faturas/mês",
                model: "Claude",
              },
              {
                icon: Mail,
                title: "Triagem e Resposta a Emails",
                desc: "Classifica emails por urgência e tema, redige respostas com base no contexto da conversa, e encaminha para a pessoa certa. Sem emails perdidos.",
                tag: "Operações",
                metric: "85% resolvidos sem humano",
                model: "GPT-4o",
              },
              {
                icon: Users,
                title: "Onboarding de Clientes",
                desc: "Recolhe documentos, valida informação, preenche campos no CRM e envia comunicações personalizadas — tudo sem intervenção manual.",
                tag: "Vendas",
                metric: "3 dias → 2 horas",
                model: "Claude",
              },
              {
                icon: MessageSquare,
                title: "Suporte ao Cliente 24/7",
                desc: "Responde a perguntas frequentes, consulta a base de conhecimento da empresa e escala para um humano quando necessário. Funciona no teu website ou WhatsApp.",
                tag: "Suporte",
                metric: "70% resolução automática",
                model: "Multi-modelo",
              },
              {
                icon: Route,
                title: "Extração de Dados e Relatórios",
                desc: "Agrega dados de múltiplas fontes (CRM, ERP, spreadsheets), gera relatórios semanais e envia sumários automaticamente para a equipa.",
                tag: "Analytics",
                metric: "8h/semana poupadas",
                model: "Gemini",
              },
              {
                icon: Eye,
                title: "Monitorização e Alertas",
                desc: "Vigia preços de concorrentes, menções nas redes sociais, ou alterações em regulamentação. Envia alertas quando algo relevante acontece.",
                tag: "Inteligência",
                metric: "Alertas em tempo real",
                model: "Multi-modelo",
              },
            ].map((agent, i) => (
